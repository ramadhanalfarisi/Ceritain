  ...
  render() {
    ...
    return (
      <ImageBackground source={currentStory.back} style={styles.container}>
        ...
        <View style={{alignSelf: 'flex-end', paddingTop: 15, paddingRight: 20}}>
          <TouchableOpacity
            ...
            <Icon name={this.state.iconSound} size={30} color="#000" />
          </TouchableOpacity>
        </View>
